...
public class SealedFirstBidAuctionTest {
    ...
    @Test
    public void testSealedValidPrices() {
        this.auction.startAuction();
        ...
        // The valid prices should contain the actual bid.
        assertTrue(this.auction.getValidPrices().contains(new Price(50000)));

        // The valid prices should contain anything higher than the bid as well
